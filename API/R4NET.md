...
R4NET ist die Netzwerkgruppe. Sie besitzt Adapter- und Konfigurationsstatus,
UDP/TCP, DNS, DHCP, ICMP, Netz-Service-Funktionen, Serial-Link und
Netzdiagnose.
...
mit hasFn. Fachliche Status- und Fehlercodes stehen in abi.zig.
