...
Kernel-Gruppentabelle `R4XStartR4Dev` v12, 368 Bytes, 42 Funktionsfelder und 44 Slots insgesamt.
...
| 43 | 360 | function | `driver_module_info` | `*const fn (u32, *DriverModuleInfo) callconv(.c) i32` |
